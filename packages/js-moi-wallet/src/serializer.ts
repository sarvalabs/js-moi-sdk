import { ErrorCode, ErrorUtils, IxType, hexToBytes, trimHexPrefix } from "js-moi-utils";
import { AssetMintOrBurnPayload, InteractionObject, InteractionPayload, LogicPayload, ProcessedIxObject } from "js-moi-signer";
