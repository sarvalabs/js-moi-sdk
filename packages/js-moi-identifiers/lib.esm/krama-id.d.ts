...
export declare class KramaId {
    ...
    getPeerId(): string;
    getDecodedPeerId(): Promise<import("@libp2p/interface").Ed25519PeerId | import("@libp2p/interface").Secp256k1PeerId | import("@libp2p/interface").RSAPeerId | import("@libp2p/interface").URLPeerId>;
    toString(): string;
    toJSON(): string;
    static peerIdFromPrivateKey(privateKey: Uint8Array): Promise<import("@libp2p/interface").PeerId>;
