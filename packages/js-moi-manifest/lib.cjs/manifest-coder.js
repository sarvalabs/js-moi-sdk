...
class ManifestCoder {
    ...
    encodeArguments(fields, args) {
        if (typeof fields === "string") {
            const callsite = this.elementDescriptor.getCallsites().get(fields);
            if (callsite == null) {
                js_moi_utils_1.ErrorUtils.throwArgumentError("Callsite not found", "fields", fields);
            }
        ...
        return "0x" + (0, js_moi_utils_1.bytesToHex)(new Uint8Array(bytes));
    }
    /**
