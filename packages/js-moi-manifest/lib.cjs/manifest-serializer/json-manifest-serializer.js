...
exports.JsonManifestSerializer = void 0;
const js_moi_utils_1 = require("js-moi-utils");
const js_polo_1 = require("js-polo");
const schema_1 = require("../schema");
const base_manifest_serializer_1 = require("./base-manifest-serializer");
class JsonManifestSerializer extends base_manifest_serializer_1.BaseManifestSerializer {
    ...
    serializeElement(element) {
        ...
        const config = JsonManifestSerializer.SCHEMA_CONFIG[element.kind];
        if (config == null) {
...
exports.JsonManifestSerializer = JsonManifestSerializer;
//# sourceMappingURL=json-manifest-serializer.js.map