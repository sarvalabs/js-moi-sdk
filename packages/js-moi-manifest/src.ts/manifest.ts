...
export class ManifestCoder {
     ...
     *
     * @param {LogicManifest.Routine | LogicManifest.Method} fields - The fields associated with the routine parameters (arguments).
     * @param {any[]} args - The arguments to encode.
     * @returns {string} The POLO-encoded calldata as a hexadecimal string prefixed with "0x".
     */
    public encodeArguments(routine: LogicManifest.Routine | LogicManifest.Method, ...args: any[]): string;
    /**
     * Encodes the provided arguments based on the given manifest routine
     ...
     * @returns {string} The POLO-encoded calldata as a hexadecimal string prefixed with "0x".
     */
    public encodeArguments(routine: LogicManifest.Routine | LogicManifest.Method | string, ...args: any[]): string {
