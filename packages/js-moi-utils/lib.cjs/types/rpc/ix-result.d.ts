...
export type IxOpResult<TOpType extends OpType> = TOpType extends OpType.AssetCreate ? AssetCreateResult : TOpType extends OpType.AssetBurn | OpType.AssetMint ? AssetSupplyResult : TOpType extends OpType.LogicDeploy ? LogicDeployResult : TOpType extends OpType.LogicInvoke | OpType.LogicEnlist ? LogicActionResult : TOpType extends OpType.ParticipantCreate | OpType.AssetTransfer | OpType.AssetApprove | OpType.AssetRevoke | OpType.AssetLockup | OpType.AssetRelease | OpType.AccountConfigure ? NoOperationResult : unknown;
