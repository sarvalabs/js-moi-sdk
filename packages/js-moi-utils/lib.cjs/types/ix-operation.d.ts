 ...
 */
export type IxOperation = Operation<OpType.AssetCreate> | Operation<OpType.AssetBurn> | Operation<OpType.AssetMint> | Operation<OpType.AssetTransfer> | Operation<OpType.LogicDeploy> | Operation<OpType.LogicInvoke> | Operation<OpType.LogicEnlist> | Operation<OpType.ParticipantCreate>;
