...
class MAS1AssetLogic {
    ...
    balanceOf(id) {
        ...
        return new js_moi_interactions_1.InteractionContext({
            ...
            payload: {
                asset_id: this.assetId,
                callsite: mas1_1.MAS1.Endpoint.BALANCEOF,
                calldata: (0, js_moi_utils_1.bytesToHex)(rawPayload),
            },
            participants: [],
            signer: this.signer,
    ...
    Decimals() {
        return new js_moi_interactions_1.InteractionContext({
            ...
            payload: {
                asset_id: this.assetId,
                callsite: mas1_1.MAS1.Endpoint.DECIMALS,
            },
            participants: [],
            signer: this.signer,
        });
    ...
    MaxSupply() {
        return new js_moi_interactions_1.InteractionContext({
            ...
            payload: {
                asset_id: this.assetId,
                callsite: mas1_1.MAS1.Endpoint.MAXSUPPLY,
            },
            participants: [],
            signer: this.signer,
        });
    ...
    CirculatingSupply() {
        return new js_moi_interactions_1.InteractionContext({
            ...
            payload: {
                asset_id: this.assetId,
                callsite: mas1_1.MAS1.Endpoint.CIRCULATINGSUPPLY,
            },
            participants: [],
            signer: this.signer,
        });
