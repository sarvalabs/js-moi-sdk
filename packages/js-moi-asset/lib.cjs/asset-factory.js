    ...
    static create(signer, symbol, supply, manager, enableEvents, manifest, callsite, ...calldata) {
        ...
        return new js_moi_interactions_1.InteractionContext({
            ...
            extraOperations: (sender) => {
                ...
                const transfer = (0, js_moi_interactions_1.buildTransferPayload)(js_moi_constants_1.KMOI_ASSET_ID, assetId.toHex(), option?.fundNewAccount ?? js_moi_constants_1.DEFAULT_NEW_ACCOUNT_FUNDING);
