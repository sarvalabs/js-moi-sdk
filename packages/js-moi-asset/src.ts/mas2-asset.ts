...
export class MAS2AssetLogic {
    ...
    public SetStaticTokenMetadata(tokenId: number | bigint, key: string, value: Uint8Array) {
        const payload: MAS2.SetStaticTokenMetadata = {
            token_id: tokenId,
            key: key,
            value: value
        }

        const rawPayload = this.polorize<MAS2.SetStaticTokenMetadata>(payload, SET_STATIC_TOKEN_METADATA_SCHEMA)
    ...
    public SetDynamicTokenMetadata(tokenId: number | bigint, key: string, value: Uint8Array) {
        const payload: MAS2.SetDynamicTokenMetadata = {
            token_id: tokenId,
            key: key,
            value: value
        }

        const rawPayload = this.polorize<MAS2.SetDynamicTokenMetadata>(payload, SET_DYNAMIC_TOKEN_METADATA_SCHEMA)
    ...
    public GetStaticMetadata(key: string) {
        const payload: MAS2.GetStaticMetadata = {
            key: key,
        }

        const rawPayload = this.polorize<MAS2.GetStaticMetadata>(payload, GET_STATIC_METADATA_SCHEMA)
    ...
    public GetDynamicMetadata(key: string) {
        const payload: MAS2.GetDynamicMetadata = {
            key: key,
        }

        const rawPayload = this.polorize<MAS2.GetDynamicMetadata>(payload, GET_DYNAMIC_METADATA_SCHEMA)
        return new InteractionContext<OpType.ASSET_INVOKE>({
            opType: OpType.ASSET_INVOKE,
            payload: {
                asset_id: trimHexPrefix(this.assetId) as Hex,
    ...
    public GetStaticTokenMetadata(tokenId: number | bigint, key: string) {
        const payload: MAS2.GetStaticTokenMetadata = {
            token_id: tokenId,
            key: key,
        }

        const rawPayload = this.polorize<MAS2.GetStaticTokenMetadata>(payload, GET_STATIC_TOKEN_METADATA_SCHEMA)
    ...
    public GetDynamicTokenMetadata(tokenId: number | bigint, key: string) {
        const payload: MAS2.GetDynamicTokenMetadata = {
            token_id: tokenId,
            key: key
        }

        const rawPayload = this.polorize<MAS2.GetDynamicTokenMetadata>(payload, GET_DYNAMIC_TOKEN_METADATA_SCHEMA)
