...
export class MAS1AssetLogic {
  ...
  private polorize<T extends MAS1.OperationPayload>(
    payload: T,
    schema: Schema,
  ): Uint8Array {
  ...
  public mintWithMetadata(
    beneficiary: string,
    staticMetadata: Record<string, Uint8Array>,
    ...
    const rawPayload = this.polorize<MAS1.MintWithMetadata>(
      payload,
  ...
  public transferFrom(
    ...
    const rawPayload = this.polorize<MAS1.Transfer>(
      payload,
  ...
  public SetStaticMetadata(key: string, value: Uint8Array) {
    ...
    const rawPayload = this.polorize<MAS1.SetStaticMetadata>(
      payload,
  ...
  public SetDynamicMetadata(key: string, value: Uint8Array) {
    ...
    const rawPayload = this.polorize<MAS1.SetDynamicMetadata>(
      payload,
  ...
  public SetStaticTokenMetadata(
    ...
    const rawPayload = this.polorize<MAS1.SetStaticTokenMetadata>(
      payload,
  ...
  public SetDynamicTokenMetadata(
    tokenId: number | bigint,
    key: string,
    value: Uint8Array,
  ) {
    ...
    const rawPayload = this.polorize<MAS1.SetDynamicTokenMetadata>(
      payload,
  ...
  public GetStaticMetadata(key: string) {
    ...
    const rawPayload = this.polorize<MAS1.GetStaticMetadata>(
      payload,
  ...
  public GetDynamicMetadata(key: string) {
    ...
    const rawPayload = this.polorize<MAS1.GetDynamicMetadata>(
      payload,
  ...
  public GetStaticTokenMetadata(tokenId: number | bigint, key: string) {
    const payload: MAS1.GetStaticTokenMetadata = {
      token_id: tokenId,
      key: key,
    };

    const rawPayload = this.polorize<MAS1.GetStaticTokenMetadata>(
      payload,
  ...
  public GetDynamicTokenMetadata(tokenId: number | bigint, key: string) {
    const payload: MAS1.GetDynamicTokenMetadata = {
      token_id: tokenId,
      key: key,
    };

    const rawPayload = this.polorize<MAS1.GetDynamicTokenMetadata>(
      payload,
