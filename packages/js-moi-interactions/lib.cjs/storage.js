...
exports.StorageWithdraw = exports.StorageDeposit = void 0;
...
class StorageDeposit {
    ...
    async build() {
        ...
        return new context_1.InteractionContext({
            opType: js_moi_utils_1.OpType.STORAGE_DEPOSIT,
            payload: {
...
class StorageWithdraw {
    ...
    build() {
        if (this._target == null)
            throw new Error("target account is required");
        return new context_1.InteractionContext({
            opType: js_moi_utils_1.OpType.STORAGE_WITHDRAW,
            payload: {
                target_account: this._target,
