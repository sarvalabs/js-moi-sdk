...
export declare class JsonRpcProvider extends EventEmitter implements Provider {
    ...
    getLogicStorage(logic: Identifier, storageId: Hex | StorageKey, option?: LogicStorageRequestOption): Promise<Hex>;
    getLogicStorage(logic: Identifier, participant: Identifier, storageKey: Hex | StorageKey, option?: LogicStorageRequestOption): Promise<Hex>;
    ...
    getAccountAsset<TOption extends AccountAssetRequestOption>(participant: Identifier, asset: Identifier, option?: TOption): Promise<SelectFromResponseModifier<AccountAsset, TOption>>;
